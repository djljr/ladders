(defproject ladders "0.1.0-SNAPSHOT"
  :description "Web application for organizing and recording results of a ladder based league/tournament"
  :url ""
  ...
  :ring {:handler ladders.handler/app
         :uberwar-name "ladders.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "ladders.jar"
